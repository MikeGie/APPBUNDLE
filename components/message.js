...
const translations = {
    ModelUpdate: {
        pl: "Model nie jest aktualny. Zaktualizuj parametry i kliknij przycisk GENERUJ.",
        de: "Das Modell ist nicht auf dem neuesten Stand. Aktualisieren Sie alle Parameter und klicken Sie auf die Schaltflache GENERIEREN.",
        en: "Model is not up-to-date. Update all parameters and click the GENERATE button."
    }
};
    ...
    render() {
        ...
        return (
          ...
          <Fixed>
            ...
            isVisible={visible}
            >
             {translations.ModelUpdate[language] || translations.ModelUpdate.en}
            </Banner>
            </Fixed>
...
export default connect(function (store) {
    return {
        ...
        language: store.uiFlags.language || 'en' // Dodanie jêzyka
    };
