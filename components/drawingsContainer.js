...
export const getDrawingColumns = (language) => [
    {
        key: 'icon',
        title: '',
        dataKey: 'icon',
    ...
    {
        key: 'type',
        title: translations.columnTitle[language] || translations.columnTitle.en, // T³umaczenie dynamiczne
        dataKey: 'name',
...
export class DrawingsContainer extends Component {
    ...
    render() {
        const { language = 'en' } = this.props; // Pobierz jêzyk (domyœlnie 'en')
                ...
                <div className="drawingsList">
                    ...
                    {({ width, height }) => {
                        ...
                        return <BaseTable className="drawingList"
                            width={newWidth}
                            height={newHeight}
                            columns={getDrawingColumns(language)}
                            data={data}
                            rowEventHandlers={{
...
export default connect(function (store) {
    ...
    return {
        ...
        language: store.uiFlags.language || 'en' // Domyœlny jêzyk to 'en'
    };
