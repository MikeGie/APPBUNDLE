...
const translations = {
    bomUnavailable: {
        pl: "Zestawienie materia³ów nie jest dostêpne",
        de: "Stückliste nicht verfugbar",
        en: "Bill of materials not available"
    }
};
    ...
    if (! bom?.columns?.length) {
      ...
      return <div className="fullheight">
        <div className="bomEmpty">
          <div className="title">
                  <Alert24 />&nbsp;{translations.bomUnavailable[this.props.language] || translations.bomUnavailable.en}
          </div>
